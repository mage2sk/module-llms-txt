<?php
/**
 * Standalone install + heartbeat reporter for Panth_LlmsTxt.
 *
...
namespace Panth\LlmsTxt\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_LlmsTxt';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-llms-txt';
